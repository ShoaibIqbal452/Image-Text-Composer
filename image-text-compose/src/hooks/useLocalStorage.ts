...
export function useLocalStorage<T>(
  ...
  const readValue = (): T => {
    // Prevent build error but keep working
 ...
 * @param prefix The prefix to match localStorage keys against
 */
export function clearLocalStorageWithPrefix(prefix: string): void {
  if (typeof window === 'undefined') {
    return;
  }
